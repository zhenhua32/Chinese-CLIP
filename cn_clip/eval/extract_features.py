...
def parse_args():
    ...
    # 是否提取图片特征
    parser.add_argument(
        "--extract-image-feats", action="store_true", default=False, help="Whether to extract image features."
    )
    # 是否提取文本特征
    parser.add_argument(
        "--extract-text-feats", action="store_true", default=False, help="Whether to extract text features."
    )
    # 图片数据路径
    parser.add_argument(
        "--image-data",
...
if __name__ == "__main__":
    ...
    assert (
        args.extract_image_feats or args.extract_text_feats
